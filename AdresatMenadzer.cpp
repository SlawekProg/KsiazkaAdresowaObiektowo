...
Adresat AdresatMenadzer::podajDaneNowegoAdresata()
{
    ...
    plikZAdresatami.ustawIdIstatniegoAdresata(idAdresata);
    return adresat;
}

void AdresatMenadzer::dodawanieNowegoAdresata()
{
    Adresat adresat;
...
{
    plikZAdresatami.edytujDaneWybranegoAdresata(adresat);
    ...
    for (vector <Adresat>::iterator itr = adresaci.begin(); itr != adresaci.end(); itr++)
    {
        if (itr->pobierzId() == idUsuwanegoAdresata)
        {
            ...
            if (znak == 't')
            {
                ...
                system("pause");
                if (idUsuwanegoAdresata == plikZAdresatami.pobierzIdIstatniegoAdresata())
